...
var config = {
    AppKey: 'LTAIwoPTZvoKVbLe',
    AppSecret: 'l3OOM1hAZhMsjDwGyiYuP565QtrAJr'
};
var obj = {
...
// 验证函数
// sms.sendMessage("15517072173","SMS_92545004","{\"num\":\"" + "111111" + "\"}",function (result) {
//     console.log('>>>'+result);
// });
